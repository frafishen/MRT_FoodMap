    ...
    <div class="hero-content text-center ">
      <div class="my-8 ld: w-full">
        ...
        <div class="flex flex-col w-full my-8 lg:flex-row">
          <div class="grid flex-grow h-52 w-44 card bg-base-300 rounded-box place-items-center cursor-pointer" @click="goFindFood">
            <div class="h-24 w-24 mt-8">
              <img src="../assets/mainpage/findfood2.png" class="h-24 w-auto" alt="mealpal">
            </div>
            <div class="my-6">
              Find F.o^o.d
            </div>
          ...
          <div class="grid flex-grow h-52 w-44 card bg-base-300 rounded-box place-items-center cursor-pointer" @click="goMealpal">
            <div class="h-24 w-24 mt-8">
              <img src="../assets/mainpage/malpals2.png" class="h-24 w-auto" alt="mealpal">
            </div>
            <div class=" my-6">
              Find Meal:Pal
            </div>
